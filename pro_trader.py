...
COINS = [
    ...
    "LINKUSDT", "MATICUSDT", "SHIBUSDT", "LTCUSDT", "ICPUSDT", "NEARUSDT", "BCHUSDT", "ETCUSDT", "OPUSDT", "ARBUSDT",
    "SUIUSDT", "INJUSDT", "APTUSDT", "RNDRUSDT", "PEPEUSDT", "FETUSDT", "TIAUSDT", "LDOUSDT", "IMXUSDT", "STXUSDT",
    "VETUSDT", "WIFUSDT", "1000SATSUSDT", "GRTUSDT", "XLMUSDT", "XMRUSDT", "KASUSDT", "HBARUSDT", "AGIXUSDT", "TUSDT",
    "PYTHUSDT", "JOEUSDT", "SEIUSDT", "JUPUSDT", "COTIUSDT", "PENDLEUSDT", "STRKUSDT", "ARKMUSDT", "LUNCUSDT", "XECUSDT",
    "DYMUSDT", "BONKUSDT", "PONKEUSDT", "FLOKIUSDT", "MAGICUSDT", "DYDXUSDT", "GMXUSDT", "SFPUSDT", "CTSIUSDT", "RAYUSDT",
    "GALUSDT", "HOOKUSDT", "CKBUSDT", "WOOUSDT", "NTRNUSDT", "SKLUSDT", "MASKUSDT", "ENSUSDT", "HIFIUSDT", "CVCUSDT",
    "IDUSDT", "YGGUSDT", "HIGHUSDT", "VELOUSDT", "SPELLUSDT", "ALICEUSDT", "BLZUSDT", "TOMOUSDT", "SUSHIUSDT", "OGNUSDT",
    "OCEANUSDT", "1INCHUSDT", "BAKEUSDT", "BELUSDT", "ZILUSDT", "KAVAUSDT", "COMPUSDT", "UMAUSDT", "CHRUSDT", "SUPERUSDT",
    "GLMRUSDT", "MOVRUSDT", "BNXUSDT", "AUDIOUSDT", "BANDUSDT", "DUSKUSDT", "QUICKUSDT", "ALPHAUSDT", "C98USDT", "MTLUSDT"
]
